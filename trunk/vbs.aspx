...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <p>The VBS will take place on June 30–July 3 at 9:30–11:30am. The theme is "Jesus,
    ...
    from age 3 to 5th grade. We will be providing nursery for kids under 3 who attend.
    There will be free snacks, fun games, crafts and activities daily.</p>
    
    <asp:HyperLink NavigateUrl="vbsregistration.aspx" Text="Click Here" Target="_blank" runat="server" /> to register.
</asp:Content>
