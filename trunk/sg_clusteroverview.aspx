...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h4>
        RPC Cluster Overview</h4>
    <h3>
        What is a Cluster?</h3>
    A Cluster is the name given to the basic small group of RPC. The church is seen
    in many expressions: the church <em>gathered</em> for whole group worship, the church
    <em>clustered</em> for small group interaction and the church <em>scattered</em>
    for individual influence as witnesses in life-spheres. Since our vision as a church
    is based on the Vine and the branches from John 15, the concept of a cluster fits
    well to convey togetherness and vital union with Christ as the Vine of life.</p>
    <h3>
        What is the purpose of a Cluster?</h3>
    Clusters are a means to cultivate health and vitality for our becoming a branch
    growing deeply in the Vine of life, filling West Chester with the hope of life.
    They provide a context for assimilation, edification, and shepherding care. Cluster
    involvement is basic to discipleship to build community, cultivate caring, encourage
    commitment and enhance communication in helping believers to grow in love for God,
    for one another, and for our neighbor. Committed, directed involvement with other
    ...
    Cluster meetings follow the format for the early church laid out in <a href="scripture.ashx?ref=Acts+2:42&width=300&height=300"
        title="Acts 2:42" class="thickbox">Acts 2:42</a>: the Apostles&rsquo; teaching
    (i.e., Bible study), fellowship (interaction around the common bond in Christ),
    breaking of bread (cultivation of Christ-centered, grace-based life, as well as
    social time together), and prayer (for mutual needs and kingdom work, to draw near
    to God and one another).
    <h3>
        When do Clusters meet?</h3>
    Clusters will ordinarily meet weekly in homes, for 90 minutes, at an agreed-upon
    time and day, ideally involving 7 to 12 participants.
    <h3>
        How do you get involved in a Cluster?</h3>
    You would contact the church office or your shepherding elder to express your interest.
    In being part of a Cluster you would commit yourself for a period of one year to
    <em>involvement</em> in the group and to <em>investment</em> of your time through
    faithful attendance, diligent study and regular prayer.
    <h4>
    ...
    <p>
        ...
        <p>
            <a name="Heb31214" id="Heb31214"></a>Hebrews 3:12-14 Take care, brothers, lest there
            be in any of you an evil, unbelieving heart, leading you to fall away from the living
            God. But exhort one another every day, as long as it is called &ldquo;today,&rdquo;
            that none of you may be hardened by the deceitfulness of sin. For we share in Christ,
            if indeed we hold our original confidence firm to the end. Click <a href="#return1">
                here</a> to return to the text.
        </p>
        <p>
            <a name="Heb102325" id="Heb102325"></a>Hebrews 10:23-25 Let us hold fast the confession
            of our hope without wavering, for he who promised is faithful. And let us consider
            how to stir up one another to love and good works, not neglecting to meet together,
            as is the habit of some, but encouraging one another, and all the more as you see
            the Day drawing near. Click <a href="#return1">here</a> to return to the text.
        </p>
        <p>
            <a name="Acts202832" id="Acts202832"></a>Acts 20:28-32 Pay careful attention to
            yourselves and to all the flock, in which the Holy Spirit has made you overseers,
            to care for the church of God, which he obtained with his own blood. I know that
            after my departure fierce wolves will come in among you, not sparing the flock;
            and from among your own selves will arise men speaking twisted things, to draw away
            the disciples after them. Therefore be alert, remembering that for three years I
            did not cease night or day to admonish everyone with tears. And now I commend you
            to God and to the word of his grace, which is able to build you up and to give you
            the inheritance among all those who are sanctified. Click <a href="#return1">here</a>
            to return to the text.
        </p>
        <p>
            <a name="Acts24447" id="Acts24447"></a>Acts 2:44-47 And all who believed were together
            ...
            And the Lord added to their number day by day those who were being saved. Click
            <a href="#return2">here</a> to return to the text.
        </p>
        <p>
            <a name="Acts242" id="Acts242"></a>Acts 2:42 And they devoted themselves to the
            apostles&rsquo; teaching and fellowship, to the breaking of bread and the prayers.
            Click <a href="#return3">here</a> to return to the text.
        </p>-->
</asp:Content>
