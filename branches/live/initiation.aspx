...
<asp:Content ID="Content5" ContentPlaceHolderID="navbar" runat="server">
    ...
    <a href="initiation.aspx" runat="server"><asp:Image ID="Initiation" ImageUrl="~/images/goodnews/initiation_b_50.gif" ImageAlign="Middle" Height="50" runat="server" /></a>
...
<asp:Content ID="Content1" ContentPlaceHolderID="text" runat="Server">
    ...
    <p>
        ...
        in us,<a href="scripture.ashx?ref=Deuteronomy+7:7-8&height=300&width=300" title="Deuteronomy 7:7-8"
            style="text-decoration: none;" class="thickbox">^</a> but only because of his
        own decision.<a href="scripture.ashx?ref=Ephesians+1:4-5&height=300&width=300" title="Ephesians 1:4-5"
            style="text-decoration: none;" class="thickbox">^</a> The Bible expresses this
        in three ways:</p>
    <ul style="padding-left: 1em;">
        ...
        <li>To those who deserve condemnation and eternal punishment in satisfaction of his
            ...
            by us in righteousness, but according to his own mercy."<a href="scripture.ashx?ref=Titus+3:4-5&height=300&width=300"
                title="Titus 3:4-5" style="text-decoration: none;" class="thickbox">^</a></li>
        <li>If mercy does not give us what we do deserve, <span style="font-style: italic;">
            ...
            grace of God to bestow new life.<a href="scripture.ashx?ref=John+3:3;+1+Corinthians+15:50;+Ezekiel+36:26-27&height=300&width=300"
                ...
                class="thickbox">^</a> In fact, the Bible says that "by grace you have been
            ...
            a result of works, so that no one may boast."<a href="scripture.ashx?ref=Ephesians+2:8-9&height=300&width=300"
                title="Ephesians 2:8-9" style="text-decoration: none;" class="thickbox">^</a>
