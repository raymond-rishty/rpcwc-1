...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <p>
        ...
        lows, spiritual questions, and many other struggles. This class is designed to answer
        questions the class may have and also to guide the students through life showing
        them who Christ is and why our lives are completely empty without Him. Communicating
        this to them sets the tone for relying on Christ and not self for all the struggles
        life may bring.</p>
    <p>
        <strong>Grades 1&ndash;4 </strong>
        <br />
        <strong>Second Floor of 314</strong><br />
        Linda Gale
    </p>
    <p>
        This year we will be studying first from the book of Exodus and learning how to
        apply the 10 Commandments in our lives. Then we'll be studying the book of Acts
        and learning how God spread His Kingdom after Christ's time on earth. Finally, we
        will be looking at little known people from the Old and New Testament who were servants
        of God.</p>
    <p>
    ...
    <p>
        ...
        us, God sent Jesus to save us from our sins, God loves and helps us trust and obey
    ...
    <p>
        ...
        and jump up and down. It is encouraging to hear the report that a child constantly
        sings the songs from class at home during the week. It is mandatory to have fun
        while studying the Bible in this class!</p>
</asp:Content>
