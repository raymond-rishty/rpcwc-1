<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Title="Reformed Presbyterian Church &mdash; Adult Sunday School Classes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <p>
        ...
        to those wanting to learn more about Christianity or for those young in the faith
        who want to focus on the basics of Christian discipleship.</p>
    <ul>
        <li>
            <p>
    ...
    <p>
        <span class="sectionHeading">TRACK 2: Biblical Foundations. </span>This track studies
        various books or themes of the Bible, or subjects related to biblical doctrine.</p>
    <ul>
        <li>
            <p>
    ...
    <p>
        <span class="sectionHeading">TRACK 3: Christian Living. </span>This track majors
        on practical theology, equipping us to bring the Bible’s teaching to the trenches
        of life</p>
    <ul>
        <li>
            <p>
